...
const KW = [
  ...
  { l: "단독홀이에요", re: /단독홀|단독.{0,2}(예식|건물|사용)|동시예식.{0,3}(없|안|아니)|한.?타임.{0,2}예식|원.?타임/g },
  ...
  { l: "분위기가 예뻐요", re: /분위기.{0,3}좋|로맨틱|고급스|예쁜.{0,2}분위기|감성.{0,2}있|인테리어|예쁘|이쁘|화려|꽃.{0,2}장식/g },
  { l: "신부대기실이 좋아요", re: /신부대기실.{0,4}(좋|예쁘|이쁘|넓|고급|만족)|대기실.{0,4}(좋|예쁘|이쁘|넓|고급)/g },
